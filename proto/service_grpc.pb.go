...
func (c *gossipClient) Handshake(ctx context.Context, in *Version, opts ...grpc.CallOption) (*Version, error) {
	...
	out := new(Version)
	err := c.cc.Invoke(ctx, Gossip_Handshake_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gossipClient) HandleEncDeck(ctx context.Context, in *EncDeck, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, Gossip_HandleEncDeck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gossipClient) HandleTakeSeat(ctx context.Context, in *TakeSeat, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, Gossip_HandleTakeSeat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
